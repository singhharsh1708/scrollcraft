/** The LinkedIn mark. lucide-react dropped its brand icons, so this is the official path. */
export default function LinkedInMark({ className = "w-4 h-4" }: { className?: string }) {
  return (
