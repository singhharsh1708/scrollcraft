...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    <section class="scroll-section" style="height:${Number(s.scrollHeight) || 1000}px; z-index:10;">
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .scroll-section { position: relative; pointer-events: auto; }
    .section-content-wrapper { position: sticky; top: 0; height: 100vh; display: flex; align-items: center; justify-content: center; overflow: hidden; }
    .section-content { opacity: 0; transform: translateY(32px); pointer-events: none; transition: opacity 0.6s cubic-bezier(0.25,0.46,0.45,0.94), transform 0.6s cubic-bezier(0.25,0.46,0.45,0.94); }
    .scroll-section.visible .section-content { opacity: 1; transform: translateY(0); pointer-events: auto; }
    #scroll-hint {
